...
class GaussianOccEncoder3D(BaseEncoder):
    ...
    def init_weights(self):
        for i, op in enumerate(self.operation_order):
            if self.layers[i] is None:
                ...
                # 中文注释：Mamba/SSM 模块有自己的专用初始化，不能被通用 Xavier 覆盖。
                if getattr(self.layers[i], "skip_encoder_xavier_init", False):
                    continue
    ...
    def forward(
        ...
        **kwargs
        ...
        gaussian_source_types = kwargs.get('gaussian_source_types', None)
